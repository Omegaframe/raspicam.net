...
namespace MMALSharp.Native.Parameters
{
    ...
    public struct MmalParameterCameraAnnotateV3Type
    {
        ...
        public MmalParameterCameraAnnotateV3Type(MmalParameterHeaderType hdr, int enable, int showShutter, int showAnalogGain, int showLens,
